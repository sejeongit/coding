...
// ;의 표기는 js에서 하나의 표현이 끝났다라는 의미
// 때로는 ; 을 생략하기도 한다. -> js문서를 한줄로 표현했을 때 그 내용이 구분이 간다면 ;을 삭제해도 무방
// var a = 10; var b = 20;
...
// ==(대입), =(값만 비교), ===(값뿐 아니라 타입 그 자체도 비교)

// var의 이름으로 사용할 수 없는 것 (예약어 ... )
// var, if, swich, for, forEach, do, while, else, in, of, function, object, array, Object, Array, Function ....
// name, const, let, 한글, 한자, 숫자첫글자, 특수문자(_ $ 제외) ...

// 결과를 확인하는 방법
// document.write('html 문서 내부에 강제로 삽입');
// alert('메세지 창을 이용하여 결과를 보여주는 기능');
...
// 중간 확인을 하기 위해 console.log()에 결과, 진행내용을 체크 -> 검증
// 문자는 ' ' 안에 사용 ( " ", ' ' 관계 없다.)
// 하나의 기능이 끝났을 때에는 ;으로 표기하여 구분
// 변수명은 지정된 몇가지는 사용하는 것이 아니다. ( 주로 카멜케이스로 사용하는 편 )
// 덧셈 기호는 숫자와 숫자가 합하면 덧셈이 되고, 문자와 숫자(문자)가 합하면 연결이 된다.
