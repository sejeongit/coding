...
// background-img:url(); -> backgroundImage = 'url('+ 소스 +')';
...
// cardNarr[1] : 차후 버튼 클릭시 나타나야 하는 내용 연결부분 체크
...
var testCard = {
  baseBg       : '../img/card_list/013-balloons.svg',
  basePar      : '카드 이미지 샘플_001',
  cardTitle    : 'animal',
  cardNarr     : '상품 디테일 설명',
  cardDetailBtn : '상세보기',
  cardLink     : 'http://naver.com',
  cardLinkNarr : '새관련 내용 상세보기'
};
