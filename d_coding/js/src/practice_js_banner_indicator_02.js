// practice_js_banner_indicator_02.js
(function($){
// jQuery

// 1. 인디케이터 클릭시 해당하는 광고 내용이 움직이게 하기
...
viewUl.css({width: (100 * newLen) + '%', position:'relative', left: -100 + '%'});
newViewLi.css({width: (100 / newLen) + '%'});


// 함수 생성
var slideMoveFn = function(n, interval){
  // setInterval 기능 및 마지막에서 처음으로 이동시
